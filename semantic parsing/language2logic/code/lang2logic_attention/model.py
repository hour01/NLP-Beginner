...
class Attention(nn.Module):
    def __init__(self, opt):
        ...
        self.linear_out = nn.Linear(self.hidden_size, opt.form_manager.vocab_size)
        if opt.dropout > 0:
            self.dropout = nn.Dropout(opt.dropout)
